...
bool ProtoM21Object::areDisjoint(std::vector<String> set1, std::vector<String> set2)
{
...
bool ProtoM21Object::isClassOrSubclass(void classFilterListSequenceIn) {
    return !this->classSet(areDisjoint(classFilterListSequenceIn));
}

std::vector<String> ProtoM21Object::classes() {
    return _classTupleCacheDict;
}
